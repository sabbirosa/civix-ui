...
const features = [
  {
    ...
    description:
      "Designed for elderly, rural users, and those with low digital literacy",
    descriptionbn:
      "বয়স্ক, গ্রামীণ ব্যবহারকারী এবং কম ডিজিটাল সাক্ষরতা সম্পন্ন ব্যক্তিদের জন্য ডিজাইন করা",
  },
  {
    ...
    description:
      "Meets international accessibility standards with screen reader support",
    descriptionbn:
      "স্ক্রিন রিডার সাপোর্ট সহ আন্তর্জাতিক অ্যাক্সেসিবিলিটি মান পূরণ করে",
  },
  {
        ...
        <div className="text-center max-w-4xl mx-auto">
          <div className="flex justify-center mb-8">
            <div className="h-20 w-20 rounded-2xl bg-gradient-to-br from-bangladesh-green to-primary-700 flex items-center justify-center shadow-lg">
              <span className="text-white font-bold text-4xl">CX</span>
            </div>
          </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-secondary-600 dark:text-gray-300 max-w-2xl mx-auto">
            Designed with accessibility, usability, and citizen-centric
            ...
            <Link key={index} href={link.href}>
              <Card className="p-6 h-full hover:shadow-lg transition-all duration-200 hover:scale-105 cursor-pointer bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                <CardContent className="p-0 text-center">
                  ...
                  <h3 className="font-semibold text-secondary-900 dark:text-gray-100 mb-2">
                    {link.title}
                  </h3>
                  <p className="text-secondary-600 dark:text-gray-300 text-sm">
                    {link.description}
